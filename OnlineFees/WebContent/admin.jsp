...
<tr><td><b>Username:</b></td><td><input type="text" placeholder="Enter Username" name="uname"></td></tr><br/>
<tr><td><b>Password:</b></td><td><input type="password" placeholder="Enter password" name="password"></td></tr><br/>
