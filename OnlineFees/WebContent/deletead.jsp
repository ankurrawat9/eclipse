...
<title>delete accountant's detail</title>
</head>
<body background="C:\ankur\OnlineFees\images\accountant.jpg">
<h1 align="center"><u>Delete Accountant's Record</u></h1>
<form action="deleteadd.jsp">
<hr align="center" width="70%">
<h3 align="center">Enter Accountant Name:<input type="text" name="uname"></h3>

<p align="center"><button type="submit">Delete</button></p>
<p align="center"><a href="adhome.jsp">Back</a></p>
<hr align="center" width="70%">
</form>
</body>
