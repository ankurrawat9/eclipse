...
<body>
<h2 align="center"><u>Student's Record </u></h2>
...
ps.setString(1,c);
	...
	if(rs.next())
	{
		...
		out.print("<tr><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+ "</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(6)+"</td><td>"+rs.getString(7)+"</td></tr>");
	...
	out.print("</table>");
	out.print("<a href='bhome.jsp'>Back</a>");
	con.close();
